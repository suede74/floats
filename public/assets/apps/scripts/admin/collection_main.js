var CollectionMain = function() {

    var handleCollectionMain = function() {
...
var formCallback = function(response) {
        ...
        if (response.Status) {
            Common.showAlert(true, 'success', '成功', response.Message, 'success', '/admin/collectionmain');
        } else {
