...
var mobileDropdowns = document.querySelectorAll('.main-menu__mobile-dropdown');
var mobileSecondDropdowns = document.querySelectorAll('.main-menu__mobile-dropdown-seconds');

var allDropdowns = [
	{selectors: mobileDropdowns, childClass: '.main-menu__mobile-ul'},
	{selectors: mobileSecondDropdowns, childClass: '.main-menu__mobile-ul-seconds'}
];
...
allDropdowns.map((dropdowns) => {
	...
	Array.prototype.forEach.call(dropdowns.selectors, (el, i) => {
		...
		el.addEventListener('click', (e) => {
			var childUl = e.target.querySelectorAll(dropdowns.childClass)[0];
