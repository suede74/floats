...
if (isset($_COOKIE['ci_session'])){
	...
	$content = file_get_contents(session_save_path() . '/ci_session' . $session_id);
	session_start();
...
// 	var_dump($CI->session);
// 	if($CI->session->userdata('CKFinder_UserRole') !== '9'){
// 		return TRUE;
// 	}
	
	if (isset($_SESSION['CKFinder_UserRole']) && $_SESSION['CKFinder_UserRole'] == 9)
	{
		return true;
	}	
...
if ($_SERVER['HTTP_HOST'] == 'localhost' || $_SERVER['HTTP_HOST'] == '127.0.0.1'){
	$baseUrl = '/mopetz/public/upload/images/';
}else {
	$baseUrl = '/public/upload/images/';
// 	$baseUrl = $_SERVER['DOCUMENT_ROOT'].'/public/upload/images/';
} 
// var_dump($baseUrl);
