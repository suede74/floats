            ...
            <form class="form-horizontal">
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <input type="text" name="pm_name_tw" class="form-control" placeholder="集合名稱">
                        </div>
                            ...
                            <?php if (!empty($lists)): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?=base_url($folder.'/'.$ctl.'/detail/'.$list['c_id'])?>" class="btn btn-outline btn-circle btn-sm blue">
