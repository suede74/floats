            ...
            <form class="form-horizontal">
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <input type="text" name="name" class="form-control" placeholder="商店名稱">
                        </div>
...
<div class="col-md-12 portlet light">        
    <div class="portlet light portlet-fit ">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-institution"></i>商店列表</div>
            <!-- <div class="tools">
                <a href="javascript:;" class="collapse" data-original-title="" title=""> </a>
                <a href="#portlet-config" data-toggle="modal" class="config" data-original-title="" title=""> </a>
                <a href="javascript:;" class="reload" data-original-title="" title=""> </a>
                    ...
                    <table class="table table-striped table-bordered table-advance table-hover">
                        ...
                        <tbody>
                            <?php if (!empty($lists)): ?>
                                ...
                                <tr>
                                    <td class="highlight"><?=$list['s_id']?></td>
                                    <td><?=$list['s_name']?></td>
                                    <td><?=(isset($status[$list['s_status']]))? $status[$list['s_status']] : ''?></td>
                                    <td class="text-center">
                                        <a href="<?=base_url($folder.'/'.$ctl.'/detail/'.$list['s_id'])?>" class="btn btn-outline btn-circle btn-sm blue">
